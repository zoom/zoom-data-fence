...
import us.zoom.data.dfence.providers.snowflake.validations.playbook.ResolvedPlaybookPatternCompanion;
    ...
    return Try.of(
        () -> {
          ...
          PlaybookPatternOptions options =
              PlaybookPatternOptions.of(grant.includeFuture(), grant.includeAll());
