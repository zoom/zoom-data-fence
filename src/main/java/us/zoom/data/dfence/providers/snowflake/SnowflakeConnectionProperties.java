...
public class SnowflakeConnectionProperties {
  ...
  @Pattern(
      regexp =
          "^(snowflake|externalbrowser|https://.*|oauth|snowflake_jwt|snowflake_password_mfa)?$")
  ...
  public String getPrivateKeyBase64() {
    ...
    // Read file once so that Hikari does not try to read it over and over with every new
    // connection.
  ...
  public String privateKeyFileToPrivateKeyBase64() {
    ...
    try {
      byte[] privateKeyBytes =
          java.nio.file.Files.readAllBytes(java.nio.file.Paths.get(privateKeyFile));
