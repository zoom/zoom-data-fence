...
public class SnowflakeStatementsService {
  ...
  public SnowflakeStatementsService(SnowflakeConnectionService snowflakeConnectionService) {
    this.snowflakeConnectionService = snowflakeConnectionService;
  }

  @Override
  public String toString() {
    return "SnowflakeStatementsService{"
          ...
          statementString -> {
            try {
              ...
              throw new DatabaseError(
                  String.format("Unable to execute statement %s", statementString), e);
            }
          });
    } catch (SQLException e) {
