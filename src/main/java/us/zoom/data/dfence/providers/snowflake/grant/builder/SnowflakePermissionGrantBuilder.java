...
public class SnowflakePermissionGrantBuilder extends SnowflakeGrantBuilder {
          ...
          new ArrayList<>() {
            {
              ...
              add(
                  new GrantValidationDefinition(
                      List.of("SELECT", "INSERT"), List.of(SnowflakeObjectType.EVENT_TABLE)));
              add(
                  new GrantValidationDefinition(
                      List.of(
                          "SELECT",
                          ...
                          "EVOLVE SCHEMA",
                          "APPLYBUDGET"),
                      List.of(SnowflakeObjectType.MATERIALIZED_VIEW, SnowflakeObjectType.VIEW)));
              add(
                  new GrantValidationDefinition(
                      List.of("USAGE"),
                      List.of(
              ...
              // We are allowing usage, read and write here. However, external stages only allow
              // usage and internal stages
              // only allow read and write. Snowflake does not distinguish stages types based on
              // object name.
              add(
                  new GrantValidationDefinition(
                      List.of("USAGE", "READ", "WRITE"), List.of(SnowflakeObjectType.STAGE)));
              add(
                  new GrantValidationDefinition(
                      List.of("MONITOR", "OPERATE"), List.of(SnowflakeObjectType.PIPE)));
              add(
                  new GrantValidationDefinition(
                      List.of("SELECT"), List.of(SnowflakeObjectType.STREAM)));
              add(
                  new GrantValidationDefinition(
                      List.of("MONITOR", "OPERATE"), List.of(SnowflakeObjectType.TASK)));
              add(
                  new GrantValidationDefinition(
                      List.of("APPLY"),
                      List.of(
              ...
              add(
                  new GrantValidationDefinition(
                      List.of("OPERATE"), List.of(SnowflakeObjectType.ALERT)));
              add(
                  new GrantValidationDefinition(
                      List.of("USAGE"), List.of(SnowflakeObjectType.SECRET)));
              add(
                  new GrantValidationDefinition(
                      ImmutableList.copyOf(
                          new ArrayList<>() {
              ...
              add(
                  new GrantValidationDefinition(
                      List.of("MONITOR"), List.of(SnowflakeObjectType.USER)));
              add(
                  new GrantValidationDefinition(
                      List.of("MONITOR", "MODIFY"), List.of(SnowflakeObjectType.RESOURCE_MONITOR)));
              add(
                  new GrantValidationDefinition(
              ...
              add(
                  new GrantValidationDefinition(
                      List.of("USAGE", "USE_ANY_ROLE"), List.of(SnowflakeObjectType.INTEGRATION)));
              add(
                  new GrantValidationDefinition(
                      List.of("USAGE"), List.of(SnowflakeObjectType.STREAMLIT)));
              add(
                  new GrantValidationDefinition(
                      List.of("INSTANTIATE", "USAGE"), List.of(SnowflakeObjectType.CLASS)));
              add(
                  new GrantValidationDefinition(
                      List.of("USAGE"), List.of(SnowflakeObjectType.INSTANCE)));
              add(
                  new GrantValidationDefinition(
                      List.of("USAGE"), List.of(SnowflakeObjectType.VOLUME)));
              ...
              add(
                  new GrantValidationDefinition(
                      List.of("READ", "WRITE"), List.of(SnowflakeObjectType.IMAGE_REPOSITORY)));
              add(
                  new GrantValidationDefinition(
                      List.of("SELECT", "REFERENCES"), List.of(SnowflakeObjectType.SEMANTIC_VIEW)));
            }
          });
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SnowflakePermissionGrantBuilder that)) return false;
