...
public class SnowflakeAccountPermissionGrantBuilder extends SnowflakeGrantBuilder {
  ...
  public static List<GrantValidationDefinition> validCombinations =
      List.of(
  ...
  public SnowflakeAccountPermissionGrantBuilder(
  ...
  public List<String> getGrantStatements() {
    ...
    return List.of(
        String.format(
            ...
            getGrant().privilege(), getGrant().granteeName(), withGrantOption));
  }
  ...
  public List<String> getRevokeStatements() {
    ...
    return List.of(
        String.format(
            ...
            getGrant().privilege(), getGrant().granteeName()));
  }

  @Override
  public boolean equals(Object o) {
    if (this == o) return true;
    if (!(o instanceof SnowflakeAccountPermissionGrantBuilder that)) return false;
