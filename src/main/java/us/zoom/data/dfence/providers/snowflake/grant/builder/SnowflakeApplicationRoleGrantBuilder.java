...
public class SnowflakeApplicationRoleGrantBuilder extends SnowflakeGrantBuilder {
  ...
  private static final List<GrantValidationDefinition> validCombinations =
      List.of(
          new GrantValidationDefinition(
              List.of("USAGE"), List.of(SnowflakeObjectType.APPLICATION_ROLE)));

  public SnowflakeApplicationRoleGrantBuilder(
  ...
  public List<String> getGrantStatements() {
    ...
    return List.of(
        String.format(
            ...
            grant.getEscapedName(), grant.grantedTo(), grant.granteeName()));
  }
  ...
  public final boolean equals(Object o) {
    if (!(o instanceof SnowflakeApplicationRoleGrantBuilder that)) return false;
