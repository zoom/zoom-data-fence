...
@Slf4j
public class SnowflakeAllMLPermissionGrantBuilder extends SnowflakeMLPermissionGrantBuilder {

    public SnowflakeAllMLPermissionGrantBuilder(SnowflakeGrantModel grant, SnowflakeGrantBuilderOptions options) {
        super(grant, options);
    }
