...
public class SnowflakeLifecycleObject implements LifecycleObject {
  ...
  public static LifecycleObject database(
      SnowflakeConnectionProvider snowflakeConnectionProvider, String databaseName) {
  ...
  public static LifecycleObject role(
      SnowflakeConnectionProvider snowflakeConnectionProvider, String roleName) {
    return new SnowflakeLifecycleObject(
        snowflakeConnectionProvider,
  ...
  public static LifecycleObject grantRole(
      SnowflakeConnectionProvider snowflakeConnectionProvider,
      String parentRole,
      String childRole) {
    return new SnowflakeLifecycleObject(
  ...
  public static LifecycleObject user(
      SnowflakeConnectionProvider snowflakeConnectionProvider, String userName) {
    return new SnowflakeLifecycleObject(
        snowflakeConnectionProvider,
  ...
  public void setup() {
    try (Connection snowflakeConnection = snowflakeConnectionProvider.getConnection()) {
      ...
      throw new RuntimeException(
          String.format("Error performing setup SQL statement %s.", setupSql), e);
    }
  }
  ...
  public void teardown() {
    try (Connection snowflakeConnection = snowflakeConnectionProvider.getConnection()) {
      ...
      throw new RuntimeException(
          String.format("Error performing teardown SQL statement %s.", teardownSql), e);
    }
  }
}
