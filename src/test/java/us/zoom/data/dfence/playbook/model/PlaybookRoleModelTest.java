...
class PlaybookRoleModelTest {
    ...
    void testPlaybookRoleModelWithUnsupportedRevokeBehavior() {
        PlaybookRoleModel role = new PlaybookRoleModel(
                "test_role",
                List.of(),
                true,
                true,
    ...
    void testPlaybookRoleModelWithNullUnsupportedRevokeBehavior() {
        ...
        assertTrue(role.enable());
        assertEquals("SECURITYADMIN", role.roleOwner());
        assertEquals(UnsupportedRevokeBehavior.IGNORE, role.unsupportedRevokeBehavior()); // Default value
    }
    ...
    void testPlaybookRoleModelWithGrants() {
        List<PlaybookPrivilegeGrant> grants = List.of(
                new PlaybookPrivilegeGrant("table", "test_table", "test_schema", "test_db", List.of("select"), true, true)
        );
    ...
    void testPlaybookRoleModelImmutability() {
        List<PlaybookPrivilegeGrant> originalGrants = List.of(
                new PlaybookPrivilegeGrant("table", "test_table", "test_schema", "test_db", List.of("select"), true, true)
        );
        ...
        assertThrows(UnsupportedOperationException.class, () -> {
            role.grants().add(new PlaybookPrivilegeGrant("table", "another_table", "test_schema", "test_db", List.of("select"), true, true));
        });
    }

    @Test
    void testPlaybookRoleModelEquality() {
        PlaybookRoleModel role1 = new PlaybookRoleModel(
                "test_role",
                List.of(),
                true,
                true,
        ...
        PlaybookRoleModel role2 = new PlaybookRoleModel(
                "test_role",
                List.of(),
                true,
                true,
        ...
        PlaybookRoleModel role3 = new PlaybookRoleModel(
                "test_role",
                List.of(),
                true,
                true,
