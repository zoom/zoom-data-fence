...
class PlaybookTest {
    ...
    static final PlaybookModel playbook = new PlaybookModel(Map.of(
            "rbac-example-role-1",
            new PlaybookRoleModel(
                    "rbac_example_1", List.of(
                    new PlaybookPrivilegeGrant("database", null, null, "my_db", List.of("usage"), true, true),
                    new PlaybookPrivilegeGrant("schema", null, "my_schema", "my_db", List.of("usage"), true, true),
            ...
            new PlaybookRoleModel(
                    ...
                    List.of(
                            new PlaybookPrivilegeGrant(
                                    ...
                                    true,
                                    true),
                            new PlaybookPrivilegeGrant("account", null, null, null, List.of("monitor"), true, true)))));
    ...
    public static Stream<FilterPlaybookParams> filterPlaybookParamsStream() {
        return Stream.of(
                new FilterPlaybookParams(
                        ...
                        new PlaybookModel(Map.of(
                                "mock-role-enabled", new PlaybookRoleModel(
                                        "mock_role_enabled", List.of(
                                        new PlaybookPrivilegeGrant(
                                                "table-enabled",
                                                "mock_table",
                                                "mock_schema",
                                                ...
                                                true,
                                                true,
                                                true), new PlaybookPrivilegeGrant(
                                                "table-disabled",
                                                "mock_table",
                                                "mock_schema",
                                                "mock_database",
                        ...
                        "mock-role-enabled", new PlaybookRoleModel(
                                "mock_role_enabled", List.of(new PlaybookPrivilegeGrant(
                                "table-enabled",
                                "mock_table",
                                "mock_schema",
                                "mock_database",
    ...
    void setUp() throws IOException {
        ...
        rolesWithEnvVarFile = new File(Objects.requireNonNull(classLoader.getResource(rolesFileName)).getFile());
    ...
    void consolidatePrivileges() {
        List<PlaybookPrivilegeGrant> grants = List.of(
                new PlaybookPrivilegeGrant(
                        "table",
                        "mock_table_a",
                        "mock_schema_a",
                ...
                new PlaybookPrivilegeGrant(
                        ...
                        true,
                        true));
        List<PlaybookPrivilegeGrant> expected = List.of(
                new PlaybookPrivilegeGrant(
                        "table",
                        "mock_table_a",
                        "mock_schema_a",
    ...
    @Test
    void importRoles() {
        List<PlaybookRoleModel> rolesProvider = List.of(
                new PlaybookRoleModel(
                        "role_a", List.of(
                        new PlaybookPrivilegeGrant(
                                "table",
        ...
        Map<String, PlaybookRoleModel> rolesExpected = Map.of(
                "role-a", new PlaybookRoleModel(
                        "role_a", List.of(new PlaybookPrivilegeGrant(
                        "table",
                        "mock_table_a",
                        "mock_schema_a",
                        "mock_db_a",
                        List.of("select", "update"),
                        true,
                        true))), "role-b", new PlaybookRoleModel(
                        "role_b",
                        List.of(new PlaybookPrivilegeGrant(
                                "table",
                                "mock_table_a",
