...
class PlaybookServiceBuilderTest {
  ...
  void setUp() {
    ...
    rolesDirectory =
        new File(
            Objects.requireNonNull(classLoader.getResource("test-data/project/roles-directory/"))
                .getFile());
    variablesFile =
        new File(
  ...
  void build() {
    ...
    PlaybookServiceBuilder playbookServiceBuilder =
        new PlaybookServiceBuilder()
            ...
            .setPlaybookYamlStrings(this.rolesFile)
            .setProfilesYamlString(profilesFile)
            .putAllVariablesFile(variablesFile)
  ...
  void buildRolesDirectory() {
    ...
    PlaybookServiceBuilder playbookServiceBuilder =
        new PlaybookServiceBuilder()
            .setEnvironmentService(this.environmentService)
            .setPlaybookYamlStrings(this.rolesDirectory)
            .setProfilesYamlString(profilesFile)
            .putAllVariablesFile(variablesFile)
            .putAllVariablesFromEnvironment();
    PlaybookService playbookService = playbookServiceBuilder.build();
