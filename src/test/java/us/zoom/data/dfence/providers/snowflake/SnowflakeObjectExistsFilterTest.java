...
class SnowflakeObjectExistsFilterTest {
  ...
  void objectExistsGrantBuilderDiffFilter() {
    when(snowflakeObjectsService.objectExists(
            "MOCK_DB.MOCK_SCHEMA.TABLE_EXISTS", SnowflakeObjectType.TABLE))
        .thenReturn(true);
    when(snowflakeObjectsService.objectExists(
            "MOCK_DB.MOCK_SCHEMA.TABLE_NOT_EXISTS", SnowflakeObjectType.TABLE))
        .thenReturn(false);

    GrantBuilderDiff grantBuilderDiffIn =
    ...
    GrantBuilderDiff grantBuilderDiffActual =
        SnowflakeObjectExistsFilter.objectExistsGrantBuilderDiffFilter(
            grantBuilderDiffIn, snowflakeObjectsService, new PlaybookModel(Map.of()));
  ...
  void objectExistsGrantBuilderDiffFilterFutureSchema() {
    when(snowflakeObjectsService.objectExists(
            "MOCK_DB.MOCK_SCHEMA_EXISTS", SnowflakeObjectType.SCHEMA))
        .thenReturn(true);
    when(snowflakeObjectsService.objectExists(
            "MOCK_DB.MOCK_SCHEMA_NOT_EXISTS", SnowflakeObjectType.SCHEMA))
        .thenReturn(false);
  ...
  void objectExistsGrantBuilderDiffFilterFutureDatabase() {
    when(snowflakeObjectsService.objectExists("MOCK_DB_EXISTS", SnowflakeObjectType.DATABASE))
        .thenReturn(true);
    when(snowflakeObjectsService.objectExists("MOCK_DB_NOT_EXISTS", SnowflakeObjectType.DATABASE))
        .thenReturn(false);
  ...
  void objectExistsGrantBuilderDiffFilterPlannedRoles() {
    when(snowflakeObjectsService.objectExists("MOCK_ROLE_EXISTS_GRANT", SnowflakeObjectType.ROLE))
        .thenReturn(true);
    when(snowflakeObjectsService.objectExists("MOCK_ROLE_EXISTS_REVOKE", SnowflakeObjectType.ROLE))
        .thenReturn(true);
    when(snowflakeObjectsService.objectExists("MOCK_ROLE_NOT_EXIST", SnowflakeObjectType.TABLE))
        .thenReturn(false);
    when(snowflakeObjectsService.objectExists("MOCK_ROLE_WILL_EXIST", SnowflakeObjectType.TABLE))
        .thenReturn(false);
    ...
    GrantBuilderDiff grantBuilderDiffActual =
        SnowflakeObjectExistsFilter.objectExistsGrantBuilderDiffFilter(
            grantBuilderDiffIn, snowflakeObjectsService, playbookModel);
    assertEquals(grantBuilderDiffExpected, grantBuilderDiffActual);
  }
}
