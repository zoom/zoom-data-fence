...
class SnowflakeOwnedObjectFilterTest {
  ...
  void keepFalseScaler() {
    SnowflakeOwnedObjectFilter snowflakeOwnedObjectFilter =
        new SnowflakeOwnedObjectFilter(
            "mock_database", "mock_schema", "mock_table", SnowflakeObjectType.TABLE, "mock_role");
  ...
  void keepFalseDatabase() {
    SnowflakeOwnedObjectFilter snowflakeOwnedObjectFilter =
        new SnowflakeOwnedObjectFilter(
            "mock_database", null, null, SnowflakeObjectType.DATABASE, "mock_role");
    SnowflakeGrantModel snowflakeGrantModel =
        new SnowflakeGrantModel(
            "OWNERSHIP", "DATABASE", "MOCK_DATABASE", "ROLE", "OTHER_ROLE", false, false, false);
    assertFalse(snowflakeOwnedObjectFilter.keep(snowflakeGrantModel));
  }
  ...
  void keepFalseSchema() {
    SnowflakeOwnedObjectFilter snowflakeOwnedObjectFilter =
        new SnowflakeOwnedObjectFilter(
            "mock_database", "mock_schema", null, SnowflakeObjectType.SCHEMA, "mock_role");
    SnowflakeGrantModel snowflakeGrantModel =
        new SnowflakeGrantModel(
            "OWNERSHIP",
            "SCHEMA",
  ...
  void keepFalseSchemaWildcard() {
    SnowflakeOwnedObjectFilter snowflakeOwnedObjectFilter =
        new SnowflakeOwnedObjectFilter(
            "mock_database", "*", null, SnowflakeObjectType.SCHEMA, "mock_role");
    SnowflakeGrantModel snowflakeGrantModel =
        new SnowflakeGrantModel(
            "OWNERSHIP",
            "SCHEMA",
  ...
  void keepTrueDatabaseSameRole() {
    ...
    SnowflakeGrantModel snowflakeGrantModel =
        new SnowflakeGrantModel(
            "OWNERSHIP", "DATABASE", "MOCK_DATABASE", "ROLE", "MOCK_ROLE", false, false, false);
    assertTrue(snowflakeOwnedObjectFilter.keep(snowflakeGrantModel));
  }
  ...
  void keepFalseUserOtherRole() {
    SnowflakeOwnedObjectFilter snowflakeOwnedObjectFilter =
        new SnowflakeOwnedObjectFilter(
            null, null, "mock_user", SnowflakeObjectType.USER, "mock_role");
    SnowflakeGrantModel snowflakeGrantModel =
        new SnowflakeGrantModel(
            "OWNERSHIP", "USER", "MOCK_USER", "ROLE", "OTHER_ROLE", false, false, false);
    assertFalse(snowflakeOwnedObjectFilter.keep(snowflakeGrantModel));
  }
  ...
  void keepTrueUserSameRole() {
    ...
    SnowflakeGrantModel snowflakeGrantModel =
        new SnowflakeGrantModel(
            "OWNERSHIP", "USER", "MOCK_USER", "ROLE", "MOCK_ROLE", false, false, false);
    assertTrue(snowflakeOwnedObjectFilter.keep(snowflakeGrantModel));
  }
  ...
  void keepTrueAccount() {
    ...
    SnowflakeGrantModel snowflakeGrantModel =
        new SnowflakeGrantModel(
            "CREATE ROLE", "ACCOUNT", "abc123", "ROLE", "OTHER_ROLE", false, false, false);
    assertTrue(snowflakeOwnedObjectFilter.keep(snowflakeGrantModel));
  }
  ...
  void keepTrueScalerOtherObjectType() {
    SnowflakeOwnedObjectFilter snowflakeOwnedObjectFilter =
        new SnowflakeOwnedObjectFilter(
            "mock_database", "mock_schema", "mock_table", SnowflakeObjectType.VIEW, "mock_role");
    SnowflakeGrantModel snowflakeGrantModel =
        new SnowflakeGrantModel(
            "OWNERSHIP",
            "TABLE",
  ...
  void keepFalseContainerSchema() {
    SnowflakeOwnedObjectFilter snowflakeOwnedObjectFilter =
        new SnowflakeOwnedObjectFilter(
            "mock_database", "mock_schema", "*", SnowflakeObjectType.TABLE, "mock_role");
    SnowflakeGrantModel snowflakeGrantModel =
        new SnowflakeGrantModel(
            "OWNERSHIP",
            "TABLE",
  ...
  void keepFalseContainerDatabase() {
    SnowflakeOwnedObjectFilter snowflakeOwnedObjectFilter =
        new SnowflakeOwnedObjectFilter(
            "mock_database", "*", "*", SnowflakeObjectType.TABLE, "mock_role");
    SnowflakeGrantModel snowflakeGrantModel =
        new SnowflakeGrantModel(
            "OWNERSHIP",
            "TABLE",
            ...
            List.of(
                ...
                SnowflakeGrantBuilder.fromGrant(
                    new SnowflakeGrantModel(
                        ...
                        false,
                        false))));
    GrantBuilderDiff grantBuilderDiffExpected =
        new GrantBuilderDiff(
            List.of(
                SnowflakeGrantBuilder.fromGrant(
                    new SnowflakeGrantModel(
                ...
                new PlaybookRoleModel(
                    ...
                    List.of(
                        new PlaybookPrivilegeGrant(
                            ...
                            true,
                            true)))));
    GrantBuilderDiff grantBuilderDiffActual =
        SnowflakeOwnedObjectFilter.filterDiff(grantBuilderDiff, playbookModel);
