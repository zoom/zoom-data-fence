...
class SnowflakeWildcardAllGrantFilterTest {
  ...
  void containerAllGrantBuilders() {
    ...
    List<SnowflakeGrantBuilder> expected =
                ...
                privilege ->
                    SnowflakeGrantBuilder.fromGrant(
                        new SnowflakeGrantModel(
                            ...
                            true)))
            .toList();
    List<SnowflakeGrantBuilder> actual =
        SnowflakeWildcardAllGrantFilter.containerAllGrantBuilders(playbookPrivilegeGrant, roleName);
            ...
            List.of(
                ...
                SnowflakeGrantBuilder.fromGrant(
                    new SnowflakeGrantModel(
                        ...
                        false,
                        true))),
            grantBuilderDiff.revoke());
    GrantBuilderDiff actual =
        SnowflakeWildcardAllGrantFilter.consolidateWildcardAllGrantBuilders(
            grantBuilderDiff, playbookPrivilegeGrants, "MOCK_ROLE");
