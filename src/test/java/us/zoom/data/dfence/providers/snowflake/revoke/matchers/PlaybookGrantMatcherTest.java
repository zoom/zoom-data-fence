...
class PlaybookGrantMatcherTest {
  ...
  void matchGrant_AgainstPlaybook_shouldReturnTrue_whenAllFieldsMatchExactly() {
    ...
    PlaybookGrantMatcher matcher = PlaybookGrantMatcher.apply();

    boolean actualMatch = matcher.matchGrantAgainstPlaybook().apply(playbookGrant, snowGrant);
  ...
  private PlaybookGrant createPlaybookGrant(
    ...
    return new PlaybookGrant(
        ...
        List.of(new GrantPrivilege(privilege)),
        grantType,
        true);
  }
