...
public class SnowflakeSysTestBase {
  ...
  public void beforeClass(
    ...
    sysadminSnowflakeConnectionProvider =
        new SnowflakeConnectionProvider(sysadminConnectionProperties, snowflakeAccount);
    securityadminSnowflakeConnectionProvider =
        new SnowflakeConnectionProvider(securityadminConnectionProperties, snowflakeAccount);
  }
}
